...
class ShopkeeperProfileView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self):
        profile, created = ShopkeeperProfile.objects.get_or_create(user=self.request.user)
        return profile
...
class WholesalerProfileView(generics.RetrieveUpdateAPIView):
    ...
    def get_object(self):
        profile, created = WholesalerProfile.objects.get_or_create(user=self.request.user)
        return profile
